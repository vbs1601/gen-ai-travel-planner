...
palm.configure(api_key='AIzaSyBAZqcxCm9_wmTXsCV2MOghLM3JWuYY5y4')
models = [m for m in palm.list_models() if 'generateText' in m.supported_generation_methods]
model = models[0].name
print(model)

# Streamlit app title and user input
st.title("🌍✈️ Travel Itinerary 🌟")
st.markdown("""
Welcome to the Travel Itinerary app! Enter your destination, select travel dates, and choose preferences to generate a personalized itinerary. Click 'Generate Itinerary' to get started.
""")
...
"""
    ...
    cal_content = str(cal)  # Use _str_ to obtain the serialized iCalendar content
